            ...
            @endif
				...
				@else
					...
					<div id="login_or_register">
						<p>Svp <a href="/{{ Config::get('chatter.routes.home') }}/login">connectez vous !</a> ou <a href="/{{ Config::get('chatter.routes.home') }}/register">Inscrivez vous</a>Afin de pouvoir respondre.</p>
					</div>
