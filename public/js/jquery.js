...
var
	...
	// Correspond à la chaîne pointillée pour caméliser
	rmsPrefix = / ^ - ms- /,
	rdashAlpha = / - ([az]) / g,

	// Utilisé par jQuery.camelCase comme callback pour remplacer ()
...
jQuery.extend ({
	...
	// Convertit en pointillés en camelCase; utilisé par les modules css et data
	// Support: IE <= 9 - 11, Edge 12 - 13
	// Microsoft a oublié de bousiller son préfixe de fournisseur (# 9572)
	camelCase: function (chaîne de caractères) {
